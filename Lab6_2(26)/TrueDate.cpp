...
void TrueDate::TDateTimeToTrueDate(TDateTime MyDate)
{
    TDateTimeToTrueDate(&MyDate);
}
...
int TrueDate::Compare(TrueDate* dt1, TrueDate* dt2, bool DateOnly)
{
...
TDateTime TrueDate::TrueDateToTDateTime()
{
	unsigned short YYYY = year;
	unsigned short MM = (unsigned short)month;
	unsigned short DD = day;
	TDateTime Temp(YYYY,MM,DD);
	return Temp;
}
